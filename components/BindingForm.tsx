...
const BindingImage = require("@/public/Images/BindingForm.jpeg");
...
const BindingForm = () => {
  ...
  return (
    <>
      <div className="lg:flex lg:flex-row gap-9 w-full h-full">
        <div className="image-container" style={{ height: "1800px" }}>
          <Image
            src={BindingImage}
            alt="Form Image"
            width={640}
        ...
        <div className=" lg:mt-20 ">
          ...
          <div className="text-sm text-black font-semibold mt-20">Address</div>
          <div className="flex flex-row gap-5 mb-3">
            <div className=" w-[280px] lg:mt-6">
              <label className="block text-gray-700 text-xs font-bold mb-1">
                Street/ house number
          ...
          <div className="mt-12">
            ...
            <div className="w-[580px] mt-8">
              <button className="w-[580px] rounded-3xl h-[40px] text-sm border  border-gray-500">
                Submit
              </button>
            </div>
          </div>
