...
const UserCard = ({
  ...
  return (
    <div className="min-w-[320px] bg-[#F4F4F4] lg:min-w-[340px] h-fit flex flex-col border shadow-xl rounded-md">
          ...
          <div className="flex justify-between p-5 items-center">
            ...
            {hasVolumes && (
              <div className="space-x-1">
                <span className="text-custom-brown font-light text-[13px]">
                  Volumes:
                </span>
