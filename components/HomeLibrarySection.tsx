...
const HomeLibrarySection = () => {
  return (
    <div className="w-full flex flex-col lg:flex-row lg:justify-around bg-custom-offwhite lg:p-16">
      <div className="w-full lg:w-2/5">
        <p className="text-custom-brown font-semibold text-[20px] m-3 lg:m-0 lg:text-[35px]">
      ...
      <div className="w-full lg:w-2/5">
        ...
        <div className="mb-4 m-3 lg:m-0">
          <p className="text-custom-gray text-[14px] lg:text-[16px]">
        ...
        <div className="m-3 lg:m-0">
          <Link
            href="/libraries"
            className="text-custom-mobile-orange text-[14px] lg:text-[16px] hover:text-custom-alert-orange"
          >
            Show all libraries
          </Link>
        </div>
